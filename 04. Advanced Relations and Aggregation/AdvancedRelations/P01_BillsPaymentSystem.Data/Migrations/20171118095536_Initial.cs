    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BankAcountId = table.Column<int>(nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankAccounts", x => x.BankAcountId);
                });
            ...
            migrationBuilder.Sql("ALTER TABLE PaymentMethods " +
                "ADD CONSTRAINT CH_CreditCardId_BankAccountId " +
                "CHECK (" +
